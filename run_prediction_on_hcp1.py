"""Script which starts from timeseries extracted on HCP. The zip file
   "HCP1.zip" contains timeseries pre-extracted using several atlases AAL,
   Harvard Oxford, BASC. HCP1.zip can be downloaded from
   "https://osf.io/5p7vb/download"
